...
public class SqlCmdConstant {
    ...
    public static final int PLAYER_INFO_SELECT_LAST_LOGIN                               = 112;

    /********************************PLAYER INFO*******************************************/
    public static final int PLAYER_SERVER_INFO_SELECT                                   = 120;
    public static final int PLAYER_SERVER_INFO_SELECT_ALL                               = 121;
