...
public interface ServerListMapper {
    ...
    List<ServerListInfoBean> getAllServerList();
    ...
    ServerListInfoBean getServerById(ServerListInfoBean serverListBean);
    ...
    void updateServerName(ServerListInfoBean serverListBean);
    ...
    void updateServerState(ServerListInfoBean serverListBean);
    ...
    void deleteServer(ServerListInfoBean serverListBean);
    ...
    void insertServer(ServerListInfoBean serverListBean);
    ...
    void updateServerIp(ServerListInfoBean serverListBean);
}
