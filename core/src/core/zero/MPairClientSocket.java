 ...
 */
public class MPairClientSocket extends Thread implements MPairSocket {

    private final PairSocket mSocket;
    private final MSocketAdapter mSocketAdapter;
    private final String mSocketKey;

    public MPairClientSocket(String ip, int port, String socketKey,MSocketAdapter adapter) {
