...
public class SqlCmdConstant {
    ...
    public static final int PLAYER_SCENE_GET_SCENE_INFO                                 = 100; // 获取人物地图数据
    ...
    /********************************PLAYER ITEM***********************************/
    public static final int PLAYER_ITEM_GET_ALL_ITEM                                    = 200; //获取某个玩家的所有物品
    public static final int PLAYER_ITEM_GET_ONE_ITEM                                    = 201; //获取某个玩家的某个物品
